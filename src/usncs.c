...
double slow1(double x);
double slow2(double x);
double sloww(double x, double dx, double orig);
double sloww1(double x, double dx, double orig);
double sloww2(double x, double dx, double orig, int n);
double bsloww(double x, double dx, double orig, int n);
double bsloww1(double x, double dx, double orig, int n);
double bsloww2(double x, double dx, double orig, int n);
int branred(double x, double *a, double *aa);
double cslow2(double x);
double csloww(double x, double dx, double orig);
double csloww1(double x, double dx, double orig);
double csloww2(double x, double dx, double orig, int n);
/*******************************************************************/
...
/*--------------------- |x| > 2^1024 ----------------------------------*/
	else if (k>0x7ff00000 || u.i[LOW_HALF] != 0) return x;    /*  x is NaN   */  
        else  return NAN.x;
