...
const static mynumber tm1022 = {0x00100000, 0}; /* 2^-1022 */

const static mynumber ln2      = { 0x3FE62E42, 0xFEFA39EF }; /* 0.69314718055994529 */
...
const static mynumber lg2e1    = { 0x3FF71547, 0x65200000 }; /* 1.4426950407214463 */ 
const static mynumber lg2e2    = { 0x3DE705FC, 0x2EEFA200 }; /* 1.6751713164886512e-10 */
...
const static mynumber three51  = { 0x43380000, 0 };         /*  6755399441055744 */
 ...
 const static mynumber tm1022 = {0, 0x00100000}; /* 2^-1022 */

 const static mynumber ln2     = { 0xFEFA39EF, 0x3FE62E42 };/* 0.69314718055994529 */
 ...
 const static mynumber lg2e1   = { 0x65200000, 0x3FF71547 };/* 1.4426950407214463 */ 
 const static mynumber lg2e2   = { 0x2EEFA200, 0x3DE705FC };/* 1.6751713164886512e-10 */
